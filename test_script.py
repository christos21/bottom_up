...
grid = SmartGrid('test_cases/test_case_1_minor_over_voltage/grid_IEEE.csv', name='IEEE')
...
grid.set_generators('test_cases/test_case_1_minor_over_voltage/generators.csv')
